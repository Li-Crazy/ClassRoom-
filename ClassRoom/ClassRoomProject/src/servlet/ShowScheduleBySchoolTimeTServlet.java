...
public class ShowScheduleBySchoolTimeTServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ShowScheduleBySchoolTimeTServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		session.setAttribute("schedule3t",schedule);
		session.setAttribute("classroomt",classroom);
